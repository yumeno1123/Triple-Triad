...
const CARD_DATA = [
    ...
    { id: 'c8', level: 1, name: 'フォカロル(小)', stats: [3, 1, 5, 2] },
    { id: 'c9', level: 1, name: 'ブラットソウル', stats: [2, 1, 1, 6] },
    { id: 'c10', level: 1, name: 'ケダチク', stats: [4, 3, 2, 4] },
    { id: 'c11', level: 1, name: 'コカトリス', stats: [2, 6, 1, 2] },

    // Level 2: Monsters
    { id: 'c12', level: 2, name: 'グラット', stats: [7, 1, 1, 3] },
    { id: 'c13', level: 2, name: 'ブエル', stats: [6, 3, 2, 2] },
    { id: 'c14', level: 2, name: 'メズマライズ', stats: [5, 4, 3, 3] },
    { id: 'c15', level: 2, name: 'グヘイスアイ', stats: [6, 3, 1, 4] },
    { id: 'c16', level: 2, name: 'ベルヘルメルヘル', stats: [3, 3, 4, 5] },
    { id: 'c17', level: 2, name: 'スラストエイビス', stats: [5, 5, 3, 2] },
    { id: 'c18', level: 2, name: 'ヘッジヴァイパー', stats: [5, 5, 1, 3] },
    { id: 'c19', level: 2, name: 'クリープス', stats: [5, 2, 2, 5] },
    { id: 'c20', level: 2, name: 'グレンデル', stats: [4, 2, 4, 5] },
    ...
    { id: 'c24', level: 3, name: 'エサンスーシ', stats: [6, 6, 3, 1] },
    { id: 'c25', level: 3, name: 'トライフェイス', stats: [3, 5, 5, 5] },
    { id: 'c26', level: 3, name: 'フォカロル', stats: [7, 3, 5, 1] },
    { id: 'c27', level: 3, name: 'ゴージュシール', stats: [7, 3, 1, 5] },
    { id: 'c28', level: 3, name: 'オチュー', stats: [5, 3, 6, 3] },
    { id: 'c29', level: 3, name: 'SAM08G', stats: [5, 4, 6, 2] },
    { id: 'c30', level: 3, name: 'ワイルドフック', stats: [4, 2, 4, 7] },
    ...
    { id: 'c37', level: 4, name: 'ボム', stats: [2, 3, 7, 6] },
    ...
    { id: 'c42', level: 4, name: 'ドラゴンイゾルデ', stats: [6, 3, 2, 7] },
    { id: 'c43', level: 4, name: 'アダマンタイマイ', stats: [4, 6, 5, 5] },
    { id: 'c44', level: 4, name: 'メルトドラゴン', stats: [7, 3, 5, 4] },
    ...
    { id: 'c52', level: 5, name: 'ルブルムドラゴン', stats: [7, 4, 2, 7] },
    ...
    { id: 'c60', level: 6, name: 'ナムタル・ウトク', stats: [1, 3, 8, 8] },
    ...
    { id: 'c69', level: 7, name: 'トライエッジ', stats: [8, 8, 5, 2] },
    ...
    { id: 'c96', level: 9, name: 'フェニックス', stats: [7, 10, 2, 7] },
    { id: 'c97', level: 9, name: 'バハムート', stats: [10, 6, 8, 2] },
    { id: 'c98', level: 9, name: 'グラシャラボラス', stats: [3, 10, 1, 10] },
