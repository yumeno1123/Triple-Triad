...
const CARD_DATA = [
    ...
    { id: 'c8', level: 1, name: 'フォカロル(小)', stats: [3, 1, 5, 2], element: 'water' },
    ...
    { id: 'c22', level: 2, name: 'グランデアーロ', stats: [5, 3, 2, 5], element: 'water' },
    ...
    { id: 'c40', level: 4, name: 'クアール', stats: [7, 4, 4, 4], element: 'thunder' },
